const DATA_VOYAGE = {
  ...
  "modeMapping": {
    "rules": [
      {
        "if": { "intensityMin": 1, "intensityMax": 2, "comfort": 3 },
        "mode": "chill_premium"
      },
      {
        "if": { "intensityMin": 1, "intensityMax": 2, "comfortMin": 1, "comfortMax": 2 },
        "mode": "chill_roots"
      },
      {
        "if": { "intensityMin": 3, "intensityMax": 4, "comfort": 3 },
        "mode": "adventure_comfort"
      },
      {
        "if": { "intensityMin": 3, "intensityMax": 4, "comfortMin": 1, "comfortMax": 2 },
        "mode": "adventure_pure"
      }
    ]
  },
